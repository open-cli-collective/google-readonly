...
$baseUrl = "https://github.com/open-cli-collective/google-readonly/releases/download/v${version}"
$zipFile = "gro_v${version}_windows_${arch}.zip"
$url = "${baseUrl}/${zipFile}"

Write-Host "Installing gro ${version} for Windows ${arch}..."
Write-Host "URL: ${url}"
...
Write-Host "gro installed successfully. Run 'gro --help' to get started."
